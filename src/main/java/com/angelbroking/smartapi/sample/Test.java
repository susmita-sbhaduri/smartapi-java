...
public class Test {
    ...
    public static void main(String[] args) throws SmartAPIException {
        try {
            ...
            //SmartConnect smartConnect = new SmartConnect("e1E8yhBb"); // PROVIDE YOUR API KEY HERE
            // Initialize Samart API using clientcode and password.
            SmartConnect smartConnect = new SmartConnect();

            // Provide your api key here
            smartConnect.setApiKey("LYpY76YM");
            ...
            User user = smartConnect.generateSession("susmita_client_ID", "bOmkali02");
...
//			/* SmartAPITicker */
//			String clientId = "susmita_client_ID";
//			User user = smartConnect.generateSession("susmita_client_ID", "<password>");
